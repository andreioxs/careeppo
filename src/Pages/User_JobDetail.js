      ...
      <Container xs="12" className='d-flex'>
        <Col md="4" className='justify-content-center'>
          ...
          <Row className='justify-content-evenly '>
            <div xs="12" className="rounded my-4 w-75" style={{ background: 'rgba(255,255,255,0.9)' }}>
            ...
            <Col sm="4">
              <Link to="/quizstart" style={{ textDecoration: 'none' }}>
                <div md="2" className='d-flex justify-content-evenly mt-5'>
                  <div className="my-4 p-3 text-center rounded-5 text-dark fw-bold w-100" style={{ background: 'rgba(255,255,255,0.9)' }}>
